...
function validateForm(event) { // Function to validate the form input
    ...
    if (firstName === "" || lastName === "" || zipCode === "") { // Check if any of the inputs are empty
        document.getElementById('validation-result').textContent = 'Invalid input'; // If any of the inputs are empty, the result will say, "Invalid input"
    } else {
        document.getElementById('validation-result').textContent = 'Valid input'; // If all the inputs are filled, the result will say, "Valid input"
